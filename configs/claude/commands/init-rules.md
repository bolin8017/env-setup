---
description: Analyze the project and scaffold CLAUDE.md plus path-scoped .claude/rules per official memory guidance, and the standard layout for a new repo
---
...
`~/.claude/CLAUDE.md` points here when a repo is being created. For a new repo, scaffold this layout; the steps below still apply.
